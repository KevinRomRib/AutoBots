...
import com.autobots.automanager.selecter.UsuarioEmailSelecionador;
...
public class EmailControle {
	...
	public ResponseEntity<Email> obterEmail(@PathVariable long id) {
		...
		if (email == null) {
			...
			for (Email e : emails) {
				User user = selecionadorUsuEmail.selecionar(users, email);
				adicionadorLinkEmail.adicionarLink(e, user);
			}
	...
	public ResponseEntity<List<Email>> obterEmails() {
		...
		if (emails.isEmpty()) {
			...
			for (Email email : emails) {
				User user = selecionadorUsuEmail.selecionar(users, email);
				adicionadorLinkEmail.adicionarLink(email, user);
			}
