...
import com.autobots.automanager.model.AddLinkCli;
...
import com.autobots.automanager.model.AtualizadorCli;
import com.autobots.automanager.model.SelectCli;
...
public class CliControle {
	...
	@Autowired
	private SelectCli selecionador;
	...
	public ResponseEntity<?> updateCli(@RequestBody Client atualizacao) {
		...
		if (client != null) {
			AtualizadorCli atualizador = new AtualizadorCli();
