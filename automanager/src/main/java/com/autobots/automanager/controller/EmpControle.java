...
import com.autobots.automanager.model.AdicionadorLinkEmpresa;
...
public class EmpControle {
	...
	@PostMapping("/cad")
	public ResponseEntity<?> cadEmp(@RequestBody Empresa empresa){
	...
	public ResponseEntity<?> updateEmp(@PathVariable Long id, @RequestBody Empresa empresa){
